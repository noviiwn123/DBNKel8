...
def deepBeliefNet(normalized_data):
    ...
    np.savetxt('C:/Users/Wahyu Novitasari/Downloads/SEMESTER 7/Machine Learning/DBN/weights/initialWeight.csv', weights, delimiter=',', header=columns, comments='')
    ...
    # columns = ','.join(['bias', 'hidden1', 'hidden2', 'hidden3', 'hidden4', 'hidden5', 'hidden6'])
    rows = ['bias', 'visible1', 'visible2', 'visible3', 'visible4', 'visible5', 'visible6', 'visible7', 'visible8']
    np.savetxt('C:/Users/Wahyu Novitasari/Downloads/SEMESTER 7/Machine Learning/DBN/weights/RBM1.csv', trained1[0], delimiter=',', header=columns, comments='')
    ...
    np.savetxt('C:/Users/Wahyu Novitasari/Downloads/SEMESTER 7/Machine Learning/DBN/weights/RBM2.csv', trained2[0], delimiter=',', header=columns, comments='')
    ...
    np.savetxt('C:/Users/Wahyu Novitasari/Downloads/SEMESTER 7/Machine Learning/DBN/weights/RBM3.csv', trained3[0], delimiter=',', header=columns, comments='')
    ...
    np.savetxt('C:/Users/Wahyu Novitasari/Downloads/SEMESTER 7/Machine Learning/DBN/weights/RBM4.csv', trained4[0], delimiter=',', header=columns, comments='')
