...
from FineTuning.initilizeModel import init
...
model = init()
dataset = pd.read_csv('C:/Users/Wahyu Novitasari/Downloads/SEMESTER 7/Machine Learning/DBN/normalizedData/TrainData.csv')
dataset = np.array(dataset)
train_network(network=model, train=dataset, l_rate=0.1, n_epoch=200)
print('\t\tTraining Time', (time.time() - start), 'seconds')
# print(model)
filename = 'C:/Users/Wahyu Novitasari/Downloads/SEMESTER 7/Machine Learning/DBN/classifier/experiments/fineTunedModel_06.pkl'
